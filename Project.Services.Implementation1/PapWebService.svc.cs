    ...
    public class PapWebService : IPAPService
    {
        ...
        private static PAP.GenericResponse UpdatePack(PackInformation pkinfo)
        {
            ...
            catch (Exception ex)
            {
                ...
                LoggingMediator.Log(ex);
                return new PAP.GenericResponse {Success = false, FailureInformation = "Error in PAPService:UpdatePack"};
            }
        }

        private static PAP.GenericResponse UpdatePackList(PackListInformation listinfo)
        {
            try
            {
                var response = new PAP.GenericResponse();
        ...
        private static PAP.GenericResponse UpdateTransferPackList(PackListInformation listinfo)
        {
            try
            {
                var response = new PAP.GenericResponse();
        ...
        private static AvailablePackLists.PackList[] LoadWriteTransferPackLists(
            List<TransferPackListHead> availableLists)
        {
            AvailablePackLists.PackList[] availpkListData;
            var packlist = new List<AvailablePackLists.PackList>();
            availableLists.ForEach(pk =>
